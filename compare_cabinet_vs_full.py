#!/usr/bin/env python3
"""
Comparison Analysis: Cabinet-Only vs Full Fiserv Parts List
...
def compare_results():
    ...
    print("="*80)
    print("COMPARISON: CABINET-ONLY vs FULL FISERV PARTS LIST MATCHING")
    print("="*80)
    ...
    # Load comprehensive results (with Full Fiserv parts list)
    try:
    ...
    print(f"\n📊 VOLUME COMPARISON:")
    print(f"   Full Fiserv parts list matching: {len(comprehensive_matches):,} matches")
    ...
    print(f"   Full Fiserv parts list:         {full_match_rate}% match rate")
    ...
    print(f"   Full Fiserv parts list:         1,303 items processed")
